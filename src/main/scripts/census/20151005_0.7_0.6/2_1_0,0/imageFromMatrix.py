...
def main(argv):
    ...
    mainFigure = plt.figure(figsize=(3.2,2.8))
    ...
    cbar = mainFigure.colorbar(image, orientation='horizontal', 
            ticks = cbarTickValues,shrink=1, pad=0.04) 

    cbar.ax.set_xticklabels([str(round(x,2)) for x in cbarTickValues])
