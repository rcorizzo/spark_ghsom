...
class Burlington(val dataset : RDD[String]) extends Serializable{
  ...
  val attributes = Array(
    ...
    Attribute(name = "precipitationintensity",
      index = 14,
      dimensionType = DimensionTypeEnum.DISTANCE_HIERARCHY_NUMERIC,
      randomValueFunction = DistanceHierarchyDimension.getRandomDimensionValue),

    Attribute(name = "precipitationprobability",
      index = 15,
      dimensionType = DimensionTypeEnum.DISTANCE_HIERARCHY_NUMERIC,
      randomValueFunction = DistanceHierarchyDimension.getRandomDimensionValue),

    Attribute(name = "precipitationaccumulation",
      index = 16,
      dimensionType = DimensionTypeEnum.DISTANCE_HIERARCHY_NUMERIC,
      randomValueFunction = DistanceHierarchyDimension.getRandomDimensionValue),
...
object BurlingtonReader {
  ...
  def main(args : Array[String]) {
    ...
    */
    ...
    var datasetReader = new Burlington(dataset)
