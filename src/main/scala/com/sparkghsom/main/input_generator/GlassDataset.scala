...
class GlassDataset (val dataset : RDD[String]) extends Serializable{
...
object GlassDataset {
  ...
  def main(args : Array[String]) {
    ...
    println(maxVector.mkString)
    */
    val dataset = sc.textFile("hdfs://192.168.101.13:9000/user/ameya/datasets/glass/glass.data")
    val datasetReader = new GlassDataset(dataset) 
