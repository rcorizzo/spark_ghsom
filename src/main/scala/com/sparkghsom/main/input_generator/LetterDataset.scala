...
class LetterDataset (val dataset : RDD[String]) extends Serializable{
...
object LetterDataset {
  
  val logger = LogManager.getLogger("Letter")
  ...
  def main(args : Array[String]) {
    ...
    println(maxVector.mkString)
    */
    val dataset = sc.textFile("hdfs://192.168.101.13:9000/user/ameya/datasets/letter/letter.data")
    val datasetReader = new LetterDataset(dataset) 
